...
#SBATCH --job-name=extract_PSYMETAB_Marco_proxies_23022021                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Marco_proxies_23022021
output=$projects/PSYMETAB/data/processed/extractions/Marco_proxies_23022021
...
#sbatch $projects/PSYMETAB/code/extractions/Marco_proxies_23022021_extract.sh
