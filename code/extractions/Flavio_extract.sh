...
#SBATCH --job-name=extract_PSYMETAB_Flavio                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Flavio
output=$projects/PSYMETAB/data/processed/extractions/Flavio
...
#sbatch $projects/PSYMETAB/code/extractions/Flavio_extract.sh
