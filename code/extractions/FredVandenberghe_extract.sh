...
#SBATCH --job-name=extract_PSYMETAB_FredVandenberghe                # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/FredVandenberghe
output=$projects/PSYMETAB/data/processed/extractions/FredVandenberghe
...
#sbatch $projects/PSYMETAB/code/extractions/FredVandenberghe_extract.sbatch
