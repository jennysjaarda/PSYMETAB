...
#SBATCH --job-name=extract_PSYMETAB_Nermine_26012021_proxies                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Nermine_26012021_proxies
output=$projects/PSYMETAB/data/processed/extractions/Nermine_26012021_proxies
...
#sbatch $projects/PSYMETAB/code/extractions/Nermine_26012021_proxies_extract.sh
