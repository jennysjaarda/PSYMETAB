...
#SBATCH --job-name=extract_PSYMETAB_Aurelie_05102020                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Aurelie_05102020
output=$projects/PSYMETAB/data/processed/extractions/Aurelie_05102020
...
#sbatch $projects/PSYMETAB/code/extractions/Aurelie_05102020_extract.sh
