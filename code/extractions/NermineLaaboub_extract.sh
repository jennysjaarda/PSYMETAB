...
#SBATCH --job-name=extract_PSYMETAB_NermineLaaboub                # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/NermineLaaboub
output=$projects/PSYMETAB/data/processed/extractions/NermineLaaboub
...
#sbatch $projects/PSYMETAB/code/extractions/NermineLaaboub_extract.sbatch
