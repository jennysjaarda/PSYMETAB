...
#SBATCH --job-name=extract_PSYMETAB_SeverineCrettolWavre                # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/SeverineCrettolWavre
output=$projects/PSYMETAB/data/processed/extractions/SeverineCrettolWavre
...
#sbatch $projects/PSYMETAB/code/extractions/SeverineCrettolWavre_extract.sbatch
