...
#SBATCH --job-name=extract_PSYMETAB_Nermine_01022021                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Nermine_01022021
output=$projects/PSYMETAB/data/processed/extractions/Nermine_01022021
...
#sbatch $projects/PSYMETAB/code/extractions/Nermine_01022021_extract.sh
