...
#SBATCH --job-name=extract_PSYMETAB_Aude                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Aude
output=$projects/PSYMETAB/data/processed/extractions/Aude
...
#sbatch $projects/PSYMETAB/code/extractions/Aude_extract.sh

#sbatch $data/sgg2/jenny/projects/PSYMETAB/code/extractions/Aude_extract.sh
