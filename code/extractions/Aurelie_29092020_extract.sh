...
#SBATCH --job-name=extract_PSYMETAB_Aurelie_29092020                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Aurelie_29092020
output=$projects/PSYMETAB/data/processed/extractions/Aurelie_29092020
...
#sbatch $projects/PSYMETAB/code/extractions/Aurelie_29092020_extract.sh
