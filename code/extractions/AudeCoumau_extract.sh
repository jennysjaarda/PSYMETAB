...
#SBATCH --job-name=extract_PSYMETAB_AudeCoumau                # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/AudeCoumau
output=$projects/PSYMETAB/data/processed/extractions/AudeCoumau
...
#sbatch $projects/PSYMETAB/code/extractions/AudeCoumau_extract.sbatch
