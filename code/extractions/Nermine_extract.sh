...
#SBATCH --job-name=extract_PSYMETAB_Nermine                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Nermine
output=$projects/PSYMETAB/data/processed/extractions/Nermine
...
#sbatch $projects/PSYMETAB/code/extractions/Nermine_extract.sh
