...
#SBATCH --job-name=extract_PSYMETAB_FirstnameLastname                # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/FirstnameLastname
output=$projects/PSYMETAB/data/processed/extractions/FirstnameLastname
...
#sbatch $projects/PSYMETAB/code/extractions/FirstnameLastname_extract.sbatch
