...
#SBATCH --job-name=extract_PSYMETAB_Nermine_26012021                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Nermine_26012021
output=$projects/PSYMETAB/data/processed/extractions/Nermine_26012021
...
#sbatch $projects/PSYMETAB/code/extractions/Nermine_26012021_extract.sh
