...
#SBATCH --job-name=extract_PSYMETAB_FlavioFerreira                # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/FlavioFerreira
output=$projects/PSYMETAB/data/processed/extractions/FlavioFerreira
...
#sbatch $projects/PSYMETAB/code/extractions/FlavioFerreira_extract.sbatch
