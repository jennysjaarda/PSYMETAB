...
#SBATCH --job-name=extract_PSYMETAB_Marco_25012021                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Marco_25012021
output=$projects/PSYMETAB/data/processed/extractions/Marco_25012021
...
#sbatch $projects/PSYMETAB/code/extractions/Marco_25012021_extract.sh
