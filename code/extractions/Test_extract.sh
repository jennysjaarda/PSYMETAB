...
#SBATCH --job-name=extract_PSYMETAB_Test                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Test
output=$projects/PSYMETAB/data/processed/extractions/Test
...
#sbatch $projects/PSYMETAB/code/extractions/Test_extract.sh
