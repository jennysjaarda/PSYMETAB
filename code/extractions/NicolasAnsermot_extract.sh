...
input=$projects/PSYMETAB/data/raw/extractions/NicolasAnsermot
output=$projects/PSYMETAB/data/processed/extractions/NicolasAnsermot
...
#sbatch $projects/PSYMETAB/code/extractions/NicolasAnsermot_extract.sbatch
