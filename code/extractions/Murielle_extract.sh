...
#SBATCH --job-name=extract_PSYMETAB_Murielle                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Murielle
output=$projects/PSYMETAB/data/processed/extractions/Murielle
...
#sbatch $projects/PSYMETAB/code/extractions/Murielle_extract.sh
