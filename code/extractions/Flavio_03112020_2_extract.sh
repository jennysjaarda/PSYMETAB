...
#SBATCH --job-name=extract_PSYMETAB_Flavio_03112020_2                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Flavio_03112020_2
output=$projects/PSYMETAB/data/processed/extractions/Flavio_03112020_2
...
#sbatch $projects/PSYMETAB/code/extractions/Flavio_03112020_2_extract.sh
