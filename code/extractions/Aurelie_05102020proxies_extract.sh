...
#SBATCH --job-name=extract_PSYMETAB_Aurelie_05102020proxies                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/Aurelie_05102020proxies
output=$projects/PSYMETAB/data/processed/extractions/Aurelie_05102020proxies
...
#sbatch $projects/PSYMETAB/code/extractions/Aurelie_05102020proxies_extract.sh
