...
#SBATCH --job-name=extract_PSYMETAB_MarcodePieri_proxies                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/MarcodePieri_proxies
output=$projects/PSYMETAB/data/processed/extractions/MarcodePieri_proxies
...
#sbatch $projects/PSYMETAB/code/extractions/MarcodePieri_proxies_extract.sh
