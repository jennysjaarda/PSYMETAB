...
#SBATCH --job-name=extract_PSYMETAB_MurielleBrocard                # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/MurielleBrocard
output=$projects/PSYMETAB/data/processed/extractions/MurielleBrocard
...
#sbatch $projects/PSYMETAB/code/extractions/MurielleBrocard_extract.sbatch
