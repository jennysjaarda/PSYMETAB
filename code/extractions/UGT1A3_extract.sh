...
#SBATCH --job-name=extract_PSYMETAB_UGT1A3                             # Job name (this name will appear in the queue)
...
input=$projects/PSYMETAB/data/raw/extractions/UGT1A3
output=$projects/PSYMETAB/data/processed/extractions/UGT1A3
...
#sbatch $projects/PSYMETAB/code/extractions/UGT1A3_extract.sh

#sbatch $data/sgg2/jenny/projects/PSYMETAB/code/extractions/UGT1A3_extract.sh
