...
for(i in 1:dim(case_only_interest)[1]){
  ...
  file.copy(from=manhattan_file_name, to=paste0("analysis/images", "/", output, "_", title, "_META_manhattan.png"), 
          overwrite = TRUE, recursive = FALSE, 
          copy.mode = TRUE)

  file.copy(from=qq_file_name, to=paste0("analysis/images", "/", output, "_", title, "_META_qq.png"), 
        overwrite = TRUE, recursive = FALSE, 
        copy.mode = TRUE)
  
  manhattan_file_name2 <- paste0("../", paste0("analysis/images", "/", output, "_", title, "_META_manhattan.png"))
  qq_file_name2 <- paste0("../", paste0("analysis/images", "/", output, "_", title, "_META_qq.png"))
...
#knitr::include_graphics(manhatten_figures)
