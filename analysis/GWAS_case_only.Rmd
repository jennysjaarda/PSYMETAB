...
for(i in 1:dim(case_only_interest)[1]){
  ...
  manhattan_file_name2 <- paste0("../", manhattan_file_name)
  qq_file_name2 <- paste0("../", qq_file_name)
  
  manhatten_figures <- c(manhatten_figures, manhattan_file_name2)
  qq_figures <- c(qq_figures, qq_file_name2)
