...
**Source code for Step 6 can be found at: [code/final_processing.sh](https://github.com/jennysjaarda/PSYMETAB/blob/master/code/final_processing.sh).**
...
mkdir archive
tar --exclude='*.psam' --exclude='*.pvar' --exclude archive -czvf archive/10_merge_imputed.tar.gz * --remove-files
