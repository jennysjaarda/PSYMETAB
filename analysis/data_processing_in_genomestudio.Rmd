...
- Clustering was performed according to the guidelines in the webinar (see [Notes on creating custom cluster files](creating_custom_cluster_files.html)) with the following procedure:
...
- As of October 11, all GS file were created, clustered and exported as PLINK files and subsequently moved to the Zoltan's.
